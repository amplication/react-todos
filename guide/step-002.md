...
Then select `Start from Scratch` and wait a few seconds for the app to be generated.
...
The first field will be `Text`. Type that into the `Add field` input and hit `enter`.
